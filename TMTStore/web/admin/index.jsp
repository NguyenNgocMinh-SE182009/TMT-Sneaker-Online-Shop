                                        ...
                                        <tbody>
                                            <c:forEach items="${orderbyday}" var="o">
                                                <tr>
                                                    ...
                                                    <td><a style=" color: rgb(245 157 57);background-color: rgb(251 226 197); padding: 5px;border-radius: 5px;" href="ordermanager?action=showdetail&order_id=${o.order_id}"><i class="fa"></i>Chi tiết đơn hàng</a></td>
                                                </tr>
                                            </c:forEach>
