                                ...
                                <tbody>
                                    <c:forEach items="${order}" var="o">
                                        <tr>
                                            ...
                                            <td>${o.date}</td>
                                            <td>${o.total}</td>
                                            <td><span class="badge bg-success">${o.payment}</span></td>
                                            <td>
                                                <a style="color: rgb(245 157 57); background-color: rgb(251 226 197); padding: 5px; border-radius: 5px;" 
                                                   href="ordermanager?action=showdetail&order_id=${o.order_id}">
                                                    <i class="fa"></i> Chi tiết đơn hàng
                                                </a>
                                                <!-- Nút Xóa -->
                                                <a style="color: white; background-color: rgb(255, 69, 58); padding: 5px; border-radius: 5px; margin-left: 5px;"
                                                   href="ordermanager?action=delete&order_id=${o.order_id}" 
        ...
        <script>
            ...
            var myApp = new function () {
                this.printTable = function () {
                    ...
                    win.document.write(tao.outerHTML);
                    win.document.close();
                    win.print();
                }
            }
